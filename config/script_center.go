...
type ScriptCenter struct {
	...
	CatalogSyncIntervalMinutes int               `mapstructure:"catalogSyncIntervalMinutes" json:"catalogSyncIntervalMinutes" yaml:"catalogSyncIntervalMinutes"`
	CatalogStaleAfterHours     int               `mapstructure:"catalogStaleAfterHours" json:"catalogStaleAfterHours" yaml:"catalogStaleAfterHours"`
}
