...
// service-action preflight and are never exposed here.
type ClusterServiceActionCapability struct {
...
type ClusterNode struct {
	...
	ServiceActions           []ClusterServiceActionCapability `gorm:"serializer:json;type:text" json:"serviceActions,omitempty"`
	ServiceActionsReportedAt *time.Time                       `json:"serviceActionsReportedAt,omitempty"`
