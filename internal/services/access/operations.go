...
var operationPermissions = map[string]string{
	...
	"website.settings.update":         PermissionWebsiteWrite,
	"website.config.update":           PermissionWebsiteWrite,
	"website.webserver.config.update": PermissionWebsiteWrite,
	...
	"fail2ban.policy_change":          PermissionSecurityWrite,
	"fail2ban.ban":                    PermissionSecurityWrite,
	"fail2ban.unban":                  PermissionSecurityWrite,
	...
	"container.compose.create":        PermissionContainerComposeWrite,
	"container.compose.edit":          PermissionContainerComposeWrite,
	"container.compose.start":         PermissionContainerComposeWrite,
	"container.compose.stop":          PermissionContainerComposeWrite,
	"container.compose.restart":       PermissionContainerComposeWrite,
	"container.compose.update":        PermissionContainerComposeWrite,
	"container.compose.delete":        PermissionContainerComposeWrite,
